...
#PALETTEV=0 3 13 1 11 26 10 6 12 16 4 15 14 23 25 7
#$(eval $(call IMG2SP, SET_MODE        , 0));
#$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)))
#$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTEV)))
#$(eval $(call IMG2SP, SET_OUTPUT      , bin))
#$(eval $(call IMG2SP, SET_IMG_FORMAT  , screen))
#$(eval $(call IMG2SP, SET_FOLDER      , tmp/))
#$(eval $(call IMG2SP, CONVERT         , img/title.png, 0, 0, titles,,))
#$(eval $(call IMG2SP, CONVERT         , img/victory.png, 0, 0, victory,,))
#$(eval $(call IMG2SP, CONVERT         , img/transition.png, 0, 0, transition,,))
#$(eval $(call IMG2SP, CONVERT_PALETTE , $(PALETTE), t_palette))
#$(eval $(call IMG2SP, CONVERT_PALETTE , $(PALETTEV), v_palette))
...
PALETTETEXT={0 2 3 4 6 9 11 13 14 15 17 18 20 24 25 26}


#$(eval $(call IMG2SPRITES,img/text.png,0,text,4,6,$(PALETTETEXT),tileset,src/))
#$(eval $(call IMG2SPRITES,img/grid_bg.png,0,grid_bg,6,10,$(PALETTETEXT),tileset,src/))
#$(eval $(call IMG2SPRITES,img/grid_fg.png,0,grid_fg,6,10,$(PALETTETEXT),mask,src/))
#$(eval $(call IMG2SPRITES,img/player.png,0,player,10,20,$(PALETTETEXT),mask,src/))
#$(eval $(call IMG2SPRITES,img/between.png,0,img,120,70,$(PALETTETEXT),src/,))
#$(eval $(call IMG2SPRITES,img/launch.png,0,launch,14,20,$(PALETTETEXT),mask,src/,))
#$(eval $(call IMG2SPRITES,img/logo.png,0,img,104,16,$(PALETTETEXT),mask,src/,))
#$(eval $(call IMG2SPRITES,img/gui.png,0,gui,6,10,$(PALETTETEXT),mask,src/))
#$(eval $(call IMG2SPRITES,img/death.png,0,death,6,10,$(PALETTETEXT),mask,src/))
#$(eval $(call IMG2SPRITES,img/effects.png,0,effects,6,10,$(PALETTETEXT),tileset,src/))
#$(eval $(call IMG2SPRITES,img/enemies_h.png,0,enemies_h,6,8,$(PALETTETEXT),tileset,src/))
#$(eval $(call IMG2SPRITES,img/enemies_v.png,0,enemies_v,4,12,$(PALETTETEXT),tileset,src/))
